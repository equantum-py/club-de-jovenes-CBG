...
const MAPS_URL =
  "https://maps.app.goo.gl/S4kDff6SKFJpFPh78";
...
function getWhatsAppUrl(
  ...
  const message =
    `¡Hola! Quiero reservar la ${producto} en talla ${talla} ` +
    "para el Campamento CBG 2026.";
...
function formatPrice(guaranies: number): string {
  return `Gs. ${guaranies.toLocaleString("es-PY")}`;
}
      ...
      <Container className="grid gap-8 py-10 sm:py-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:py-16">
        <div className="order-2 lg:order-1">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-brand-muted sm:text-xl">
            Una experiencia para escuchar la Palabra, examinar la fe y
            compartir un tiempo de comunión con propósito.
          </p>
          ...
          <div className="relative mx-auto max-w-2xl overflow-hidden rounded-[2rem] bg-brand-warmWhite lg:rounded-[3rem]">
            <picture>
              ...
              <Image
                ...
                alt="Gracia Camp 2026, por gracia somos salvos"
                width={1920}
                height={640}
                priority
    ...
    <section className="bg-brand-warmWhite py-16 sm:py-20 lg:py-24">
      <Container className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          ...
          >
            <p>
              El campamento está pensado como un espacio de reflexión
              bíblica, comunión y respuesta sincera al evangelio.
            </p>
          </SectionHeader>
        ...
        <div className="relative min-h-[260px] overflow-hidden rounded-[2rem] sm:min-h-[380px] lg:min-h-[520px]">
          <Image
            ...
            alt="Campamento juvenil durante la noche"
            fill
...
function RemeraSection() {
  ...
  const reservationUrl = selectedSize
    ? getWhatsAppUrl(remera.nombre, selectedSize)
    : "#";
  ...
  function handleReservationClick(
    ...
    window.alert(
      "Elegí un talle antes de reservar por WhatsApp."
    );
  }
      ...
      <Container className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg leading-8 text-brand-muted">
            Elegí tu talle y reservá la remera oficial de Gracia Camp
            por WhatsApp. Diseño oficial del campamento disponible por
            tiempo limitado.
          </p>
              ...
              {TALLAS.map((talla) => {
                ...
                return (
                  <button
                    ...
                    className={`min-h-11 min-w-12 rounded-full border px-4 text-sm font-semibold transition ${
                      isSelected
                        ? "border-brand-forest bg-brand-forest text-white"
                        : "border-brand-border bg-brand-warmWhite text-brand-muted hover:border-brand-forest hover:text-brand-forest"
                    }`}
                  >
                    {talla}
                  </button>
...
function LugarSection() {
  return (
    <section
      id="lugar"
      className="bg-brand-warmWhite py-16 sm:py-20 lg:py-24"
    >
      <Container className="grid gap-8 lg:grid-cols-[0.42fr_0.58fr] lg:items-start">
        <div>
          <SectionHeader
            eyebrow="Ubicación"
            title="Lugar del campamento"
          >
            <p>
              Campamento Kavaju - Palabra de Vida, en Atyrá,
              Paraguay.
            </p>
          </SectionHeader>
  ...
  return (
    ...
    >
      <Container>
        ...
        >
          <p>
            Una mirada breve para conocer mejor el espíritu y la
      ...
      <Container className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-base leading-8 text-white/75">
            Estas normas nos ayudarán a vivir este tiempo con orden,
            respeto y propósito.
          </p>
        </div>
...
function Footer() {
  const message =
    "¡Hola! Quiero consultar sobre el Campamento CBG 2026.";
