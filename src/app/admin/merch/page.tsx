      ...
      <section className="rounded-2xl border border-brand-border bg-white p-5 sm:p-6">
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-2">
          <div className="rounded-2xl border border-brand-border bg-brand-cream/50 p-4">
            ...
            <input name="banner_desktop" type="file" accept="image/jpeg,image/png,image/webp" className="mt-4 block w-full rounded-xl border border-brand-border bg-white p-3 text-sm text-brand-forest"/>
          </div>
          <div className="rounded-2xl border border-brand-border bg-brand-cream/50 p-4">
            ...
            <input name="banner_mobile" type="file" accept="image/jpeg,image/png,image/webp" className="mt-4 block w-full rounded-xl border border-brand-border bg-white p-3 text-sm text-brand-forest"/>
          </div>
        </div>
