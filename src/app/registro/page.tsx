...
export default function RegistroPage(){
  ...
  const paymentReady=Boolean(payment.bankName&&payment.accountHolder&&payment.accountNumber&&payment.documentNumber);
