...
export async function getRegistrations(): Promise<Registration[]> {
  ...
  return rows.map((registration) => ({
    ...
    DeseaRemera: registration.deseaRemera,
    TalleRemera: registration.talleRemera,
    PrecioCampamento: String(registration.precioCampamento),
    PrecioRemera: String(registration.precioRemera),
    TotalTransferir: String(registration.totalTransferir),
